 ...
 * @subpackage Plugins
 */
class TexturizePlugin extends PapyrinePlugin implements PapyrineModifier
{
	const TITLE       = "Texturize Modifier Plugin";
	const DESCRIPTION = "Coverts from Texturize markup to XHTML";
	const WEBSITE     = "http://photomatt.net/tools/texturize/";
	const VERSION     = 0.1;
