<?php
	 ...
	 * @subpackage Plugins
	 */
	class WikiPlugin extends PapyrinePlugin
	{
		final $TextWikiClassFile = "Text_Wiki-0.17/Text/Wiki.php";
		...
		/**
		 * Convience function to convert using TextWiki.
		 *
		...
		{
			require_once ($this->TextWikiClassFile);
